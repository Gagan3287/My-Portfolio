...
const KB = {
    ...
    projects: {
        ...
        answer: `Here are Gagan's key projects 🚀\n\n**1. StudyMate AI** — Full-stack AI study & placement companion for engineering students. Upload notes/PDFs to get instant summaries, flashcards & quizzes. Includes a RAG-grounded chatbot with source citations, a self-trained ML retention model (Half-Life Regression) for adaptive spaced repetition, an interactive knowledge graph, and a resume vs JD skill-gap analyzer.\n🔗 studymate-aix.vercel.app\n\n**2. Quill AI** — Next-gen AI writing & research platform powered by OpenAI large language models. Features content generation, smart summarisation, context-aware Q&A, and real-time grammar suggestions.\n🔗 quill-ai-eight.vercel.app\n\n**3. RuleBot – Intelligent Rule-Based AI Chatbot** — Full-stack AI chatbot with a Next.js frontend and FastAPI backend. Uses a rule-based engine (no generative AI), REST API, Docker, and is deployed on Vercel & Render.\n🔗 codsoft-task-01-phi.vercel.app`,
    },
    certifications: {
